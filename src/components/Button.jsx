...
function Button({ children, onClick, to, type }) {
  ...
  const small =
    "text-2xl rounded-md border-1 border-burnt-peach-600 bg-burnt-peach-500 py-1 px-3.5 font-bold text-golden-sand-50 hover:bg-burnt-peach-400 transition-all duration-200 ";
  const className = {
    login,
    base,
    small,
