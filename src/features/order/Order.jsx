    ...
    <Form method="post" className="mx-4 mt-8 flex flex-col gap-4 sm:max-w-7/10">
      ...
      <div className="mb-4 flex items-center gap-4">
        <input
          ...
          name="priority"
          id="Priority"
          className="border-slate-blue-400 bg-slate-blue-100 checked:border-slate-blue-400 checked:bg-slate-blue-500 hover:border-slate-blue-300 hover:bg-slate-blue-400 focus-visible:ring-slate-blue-400 focus-visible:ring-offset-slate-blue-900 size-5 cursor-pointer appearance-none rounded-md border-2 transition-all duration-150 checked:scale-110 checked:bg-[url('data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2016%2016%22%3E%3Cpath%20fill%3D%22none%22%20stroke%3D%22white%22%20stroke-width%3D%222.5%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%20d%3D%22M3%208l3.5%203.5L13%204.5%22%2F%3E%3C%2Fsvg%3E')] checked:bg-center checked:bg-no-repeat focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none active:scale-90"
        />
